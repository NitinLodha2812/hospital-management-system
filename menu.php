...
background-image: -moz-linear-gradient(#4834DF, #4C4B4B); 
background-image: -webkit-gradient(linear, left top, left bottom, from(#4834DF), to(#4C4B4B)); 
background-image: -webkit-linear-gradient(#4834DF, #4C4B4B); 
background-image: -o-linear-gradient(#4834DF, #4C4B4B);
background-image: -ms-linear-gradient(#4834DF, #4C4B4B);
background-image: linear-gradient(#4834DF, #4C4B4B);
...
background-image: -moz-linear-gradient(#BB2CD9, #8B78E6); 
background-image: -webkit-gradient(linear, left top, left bottom, from(#BB2CD9), to(#8B78E6));
background-image: -webkit-linear-gradient(#BB2CD9, #8B78E6);
background-image: -o-linear-gradient(#BB2CD9, #8B78E6);
background-image: -ms-linear-gradient(#BB2CD9, #8B78E6);
background-image: linear-gradient(#BB2CD9, #8B78E6);
}
