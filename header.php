...
.dropdown-content a:hover {background-color: #A4B0BD}
...
<style>
input[type=submit]{
background-color: #10A881; /* Green */ border: none; 
cursor:pointer;
color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px;
}
input[type=reset]{
background-color: #10A881; /* Green */ border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px;
}
input[type=text]{
	display: block;
    width: 75%;
...
<centre><a href="index.php"><img src="images/VIT Hospital Management System.png"></a></centre>
  <div id="head">
